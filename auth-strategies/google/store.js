...
class GoogleStoreStrategy extends (0, Strategy_1.PassportStrategy)(passport_google_oauth2_1.Strategy, types_2.GOOGLE_STORE_STRATEGY_NAME) {
...
function getGoogleStoreAuthRouter(google, configModule) {
    ...
    const authPath = (_a = google.store.authPath) !== null && _a !== void 0 ? _a : '/store/auth/google';
    router.get(authPath, (0, cors_1.default)(storeCorsOptions));
    router.get(authPath, passport_1.default.authenticate(types_2.GOOGLE_STORE_STRATEGY_NAME, {
        scope: [
    ...
    const expiresIn = (_b = google.store.expiresIn) !== null && _b !== void 0 ? _b : types_1.TWENTY_FOUR_HOURS_IN_MS;
    const callbackHandler = (0, build_callback_handler_1.buildCallbackHandler)('store', configModule.projectConfig.jwt_secret, expiresIn, google.store.successRedirect);
    const authPathCb = (_c = google.store.authCallbackPath) !== null && _c !== void 0 ? _c : '/store/auth/google/cb';
    ...
    router.get(authPathCb, (req, res, next) => {
        ...
        next();
    }, passport_1.default.authenticate(types_2.GOOGLE_STORE_STRATEGY_NAME, {
