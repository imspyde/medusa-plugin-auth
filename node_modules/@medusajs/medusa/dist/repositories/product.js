...
var ProductRepository = /** @class */ (function (_super) {
    ...
    ProductRepository.prototype.queryProducts = function (optionsWithoutRelations, shouldCount) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tags, price_lists, sales_channels, discount_condition_id, qb, toSelect_1, parsed, entities, count, result;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        discount_condition_id = (_g = optionsWithoutRelations === null || optionsWithoutRelations === void 0 ? void 0 : optionsWithoutRelations.where) === null || _g === void 0 ? void 0 : _g.discount_condition_id;
                        (_h = optionsWithoutRelations === null || optionsWithoutRelations === void 0 ? void 0 : optionsWithoutRelations.where) === null || _h === void 0 ? true : delete _h.discount_condition_id;
                        ...
                        if (discount_condition_id) {
                            qb.innerJoin("discount_condition_product", "dc_product", "dc_product.product_id = product.id AND dc_product.condition_id = :dcId", { dcId: discount_condition_id });
                        }
    ...
    ProductRepository.prototype.getFreeTextSearchResultsAndCount = function (q, options, relations) {
        ...
        if (relations === void 0) { relations = []; }
        return __awaiter(this, void 0, void 0, function () {
            var cleanedOptions, qb, discountConditionId, _a, results, count, products;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        discountConditionId = options.where.discount_condition_id;
                        if (discountConditionId) {
                            qb.innerJoin("discount_condition_product", "dc_product", "dc_product.product_id = product.id AND dc_product.condition_id = :dcId", { dcId: discountConditionId });
                        }
