...
var PublishableApiKeyService = /** @class */ (function (_super) {
    ...
    function PublishableApiKeyService(_a) {
        var manager = _a.manager, eventBusService = _a.eventBusService, publishableApiKeyRepository = _a.publishableApiKeyRepository;
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        publishableApiKeyRepo = manager.getCustomRepository(this.publishableApiKeyRepository_);
    ...
    PublishableApiKeyService.prototype.retrieve = function (publishableApiKeyId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieve_({ id: publishableApiKeyId }, config)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    PublishableApiKeyService.prototype.retrieve_ = function (selector, config) {
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var repo, _a, relations, query, publishableApiKey, selectorConstraints;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repo = this.manager_.getCustomRepository(this.publishableApiKeyRepository_);
                        _a = (0, utils_1.buildQuery)(selector, config), relations = _a.relations, query = __rest(_a, ["relations"]);
                        return [4 /*yield*/, repo.findOneWithRelations(relations, query)];
                    case 1:
                        publishableApiKey = _b.sent();
    ...
    PublishableApiKeyService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, pubKeyRepo, q, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                        pubKeyRepo = manager.getCustomRepository(this.publishableApiKeyRepository_);
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        publishableApiKeyRepository = manager.getCustomRepository(this.publishableApiKeyRepository_);
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        repo = manager.getCustomRepository(this.publishableApiKeyRepository_);
