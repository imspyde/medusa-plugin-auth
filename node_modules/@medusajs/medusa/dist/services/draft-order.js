                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 9:
                                        createdCart = _d.sent();
                                        return [4 /*yield*/, cartServiceTx.retrieve(createdCart.id, {
                                    ...
                                    case 12:
                                        ...
                                        _d.label = 13;
                                    case 13:
                                        _d.trys.push([13, 21, 22, 23]);
                                        items_1 = __values(items), items_1_1 = items_1.next();
                                        _d.label = 14;
                                    case 14:
                                        if (!!items_1_1.done) return [3 /*break*/, 20];
                                        item = items_1_1.value;
                                        if (!item.variant_id) return [3 /*break*/, 17];
                                    ...
                                    case 25:
                                        _d.sent();
                                        _d.label = 26;
                                    case 26: return [4 /*yield*/, cartServiceTx.addShippingMethod(createdCart.id, method.option_id, method.data)];
                                    case 27:
                                        _d.sent();
                                        _d.label = 28;
                                    case 28:
