...
declare class ShippingOptionService extends TransactionBaseService {
    ...
    constructor({ manager, shippingOptionRepository, shippingOptionRequirementRepository, shippingMethodRepository, fulfillmentProviderService, regionService, featureFlagRouter, }: InjectedDependencies);
    /**
     ...
     */
    validateRequirement_(requirement: ShippingOptionRequirement, optionId?: string | undefined): Promise<ShippingOptionRequirement>;
    /**
     ...
     */
    retrieve(optionId: any, options?: {
        select?: (keyof ShippingOption)[];
        relations?: string[];
