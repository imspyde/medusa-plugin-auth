...
export declare class PaymentCollectionSessionInputRequest {
    provider_id: string;
    customer_id: string;
    amount: number;
    session_id?: string;
}
export declare class StoreManagePaymentCollectionSessionRequest {
    sessions: PaymentCollectionSessionInputRequest | PaymentCollectionSessionInputRequest[];
}
