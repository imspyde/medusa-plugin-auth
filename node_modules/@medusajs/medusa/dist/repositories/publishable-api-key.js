...
var publishable_api_key_1 = require("../models/publishable-api-key");
var PublishableApiKeyRepository = /** @class */ (function (_super) {
    __extends(PublishableApiKeyRepository, _super);
    function PublishableApiKeyRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PublishableApiKeyRepository.prototype.findWithRelations = function (relations, idsOrOptionsWithoutRelations) {
    ...
    PublishableApiKeyRepository.prototype.findOneWithRelations = function (relations, optionsWithoutRelations) {
        if (relations === void 0) { relations = []; }
    ...
    PublishableApiKeyRepository = __decorate([
        (0, typeorm_1.EntityRepository)(publishable_api_key_1.PublishableApiKey)
    ], PublishableApiKeyRepository);
    return PublishableApiKeyRepository;
}(typeorm_1.Repository));
exports.PublishableApiKeyRepository = PublishableApiKeyRepository;
