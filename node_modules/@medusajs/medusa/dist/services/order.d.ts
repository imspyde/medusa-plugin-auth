...
import { Address, Cart, LineItem, Order, Return, TrackingLink } from "../models";
...
declare class OrderService extends TransactionBaseService {
    ...
    retrieveWithTotals(orderId: string, options?: FindConfig<Order>, totalsConfig?: TotalsConfig): Promise<Order>;
    /**
     ...
     * @protected
     */
    decorateTotals(order: Order, totalsFieldsOrConfig?: string[] | TotalsConfig): Promise<Order>;
    /**
