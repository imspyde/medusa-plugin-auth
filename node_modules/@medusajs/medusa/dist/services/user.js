...
var UserService = /** @class */ (function (_super) {
    ...
    UserService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, userRepo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                        userRepo = manager.getCustomRepository(this.userRepository_);
                        return [4 /*yield*/, userRepo.find((0, utils_1.buildQuery)(selector, config))];
    ...
    UserService.prototype.retrieve = function (userId, config) {
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var manager, userRepo, query, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var userRepo, createData, validatedEmail, hashedPassword, created, newUser;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        userRepo = manager.getCustomRepository(this.userRepository_);
