...
var CartService = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cartRepo, addressRepo, rawCart, _a, customer, region, regCountries, addr, addr, remainingFields, remainingFields_1, remainingFields_1_1, remainingField, key, createdCart, cart;
                            var e_1, _b;
                            var _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 8:
                                        ...
                                        if (!data.billing_address_id) return [3 /*break*/, 10];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                                var cart, lineItemServiceTx, currentItem, _a, existingItem, quantity;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 6:
                                            // Confirm inventory or throw error
                                            _b.sent();
                                            if (!currentItem) return [3 /*break*/, 8];
                                        ...
                                        case 7:
                                            _b.sent();
                                            return [3 /*break*/, 10];
                                        case 8: return [4 /*yield*/, lineItemServiceTx.create(__assign(__assign({}, lineItem), { has_shipping: false, cart_id: cart.id }))];
                                        case 9:
                                            _b.sent();
                                            _b.label = 10;
                                        case 10: return [4 /*yield*/, lineItemServiceTx
                                ...
                                switch (_f.label) {
                                    ...
                                    case 23:
                                        ...
                                        if (!((data.email && data.email !== originalCartCustomer.email) ||
                                            (data.customer_id && data.customer_id !== originalCartCustomer.id))) return [3 /*break*/, 25];
                                        return [4 /*yield*/, this.eventBus_
                                                .withTransaction(transactionManager)
    ...
    CartService.prototype.addShippingMethod = function (cartId, optionId, data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cart, cartCustomShippingOptions, customShippingOption, shipping_methods, shippingMethodConfig, newShippingMethod, methods, shippingOptionServiceTx, shipping_methods_1, shipping_methods_1_1, shippingMethod, e_2_1, lineItemServiceTx_1, updatedCart;
                            var e_2, _a;
                            var _this = this;
                            var _b;
                            return __generator(this, function (_c) {
    ...
    CartService.prototype.decorateTotals_ = function (cart, totalsToSelect, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totals, totalsToSelect_1, totalsToSelect_1_1, key, _a, _b, _c, _d, _e, giftCardBreakdown, _f, e_3_1;
            var e_3, _g;
