...
var OrderEditService = /** @class */ (function (_super) {
    ...
    OrderEditService.prototype.retrieve = function (orderEditId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, orderEditRepository, query, orderEdit;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        orderEditRepository = transactionManager.getCustomRepository(this.orderEditRepository_);
    ...
    OrderEditService.prototype.confirm = function (orderEditId, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var orderEditRepository, orderEdit, lineItemServiceTx;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        orderEditRepository = manager.getCustomRepository(this.orderEditRepository_);
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, Promise.all([
                                                lineItemServiceTx.update({ order_id: orderEdit.order_id }, { order_id: null }),
    ...
    OrderEditService.prototype.retrieveActive = function (orderId, config) {
        ...
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var manager, orderEditRepository, query;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = (_a = this.transactionManager_) !== null && _a !== void 0 ? _a : this.manager_;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        lineItemServiceTx = this.lineItemService_.withTransaction(manager);
                        lineItemAdjustmentServiceTx = this.lineItemAdjustmentService_.withTransaction(manager);
                        taxProviderServiceTs = this.taxProviderService_.withTransaction(manager);
                        return [4 /*yield*/, lineItemServiceTx.list({
                                order_edit_id: orderEditId,
                            }, {
