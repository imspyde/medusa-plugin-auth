...
exports.default = (function (directory, featureFlagRouter) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, configModule, error, plugins, resolved, migrationDirs, coreMigrations, resolved_1, resolved_1_1, p, exists;
    var e_1, _b;
    return __generator(this, function (_c) {
        _a = (0, medusa_core_utils_1.getConfigFile)(directory, "medusa-config"), configModule = _a.configModule, error = _a.error;
        if (error) {
