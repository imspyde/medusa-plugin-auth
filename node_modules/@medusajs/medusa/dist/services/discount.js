...
var DiscountService = /** @class */ (function (_super) {
    ...
    DiscountService.prototype.retrieveByCode = function (discountCode, config) {
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var manager, discountRepo, normalizedCode, query, discount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 3:
                                        ...
                                        _a = discount;
                                        return [4 /*yield*/, Promise.all(regions.map(function (regionId) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                    ...
                                    case 5:
                                        if (metadata) {
                                            discount.metadata = (0, utils_1.setMetadata)(discount, metadata);
                                        }
                                        if (rule) {
                                            ruleUpdate = rule;
                                            if (rule.value) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var adjustment, discount, _a, type, value, allocation, fullItemPrice, calculationContext, lineItemTotals, subtotal, nominator, totalItemPercentage;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        adjustment = 0;
