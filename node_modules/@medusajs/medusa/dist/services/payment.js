...
var PaymentService = /** @class */ (function (_super) {
    ...
    function PaymentService(_a) {
        var manager = _a.manager, paymentRepository = _a.paymentRepository, paymentProviderService = _a.paymentProviderService, eventBusService = _a.eventBusService;
        var _this = 
    ...
    PaymentService.prototype.retrieve = function (paymentId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, paymentRepository, query, payment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = (_a = this.transactionManager_) !== null && _a !== void 0 ? _a : this.manager_;
                        paymentRepository = manager.getCustomRepository(this.paymentRepository_);
