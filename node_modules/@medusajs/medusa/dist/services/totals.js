...
var TotalsService = /** @class */ (function (_super) {
    ...
    TotalsService.prototype.getLineDiscounts = function (cartOrOrder, discount) {
        ...
        if ("swaps" in cartOrOrder && cartOrOrder.swaps.length) {
            try {
                for (var _d = __values(cartOrOrder.swaps), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var s = _e.value;
        ...
        if ("claims" in cartOrOrder && cartOrOrder.claims.length) {
            try {
                for (var _f = __values(cartOrOrder.claims), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var c = _g.value;
    ...
    TotalsService.prototype.getLineItemTotals = function (lineItem, cartOrOrder, options) {
        ...
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var calculationContext, _b, lineItemAllocation, subtotal, discount_total, lineItemTotals, taxRate, includesTax, taxIncludedInPrice, taxLines, _c, noDiscountContext, _d;
