...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, paymentCollectionService;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                paymentCollectionService = req.scope.resolve("paymentCollectionService");
                return [4 /*yield*/, paymentCollectionService.delete(id)];
            case 1:
                _a.sent();
                res.status(200).json({ id: id, deleted: true, object: "payment_collection" });
                return [2 /*return*/];
        }
    });
}); });
//# sourceMappingURL=delete-payment-collection.js.map