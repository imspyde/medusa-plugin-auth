...
var CartCompletionStrategy = /** @class */ (function (_super) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.idempotencyKeyService_
                                            ...
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, this.handleStarted(id, { manager: manager })];
    ...
    CartCompletionStrategy.prototype.handleStarted = function (id, _a) {
    ...
    CartCompletionStrategy.prototype.handlePaymentAuthorized = function (id, _a) {
        ...
        var manager = _a.manager;
        return __awaiter(this, void 0, void 0, function () {
            var orderServiceTx, cart, swapId, swap, error_2, order, error_3;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        cart = _c.sent();
                        if (!(cart.type === "swap")) return [3 /*break*/, 6];
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 5, , 6]);
                        swapId = (_b = cart.metadata) === null || _b === void 0 ? void 0 : _b.swap_id;
                        return [4 /*yield*/, this.swapService_
                                .withTransaction(manager)
                    ...
                    case 9:
                        error_3 = _c.sent();
                        if (!(error_3 && error_3.message === order_1.ORDER_CART_ALREADY_EXISTS_ERROR)) return [3 /*break*/, 11];
                    ...
                    case 13: return [4 /*yield*/, orderServiceTx.retrieveWithTotals(order.id, {
