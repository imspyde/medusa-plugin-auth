...
var LineItemAdjustmentService = /** @class */ (function (_super) {
    ...
    function LineItemAdjustmentService(_a) {
        var manager = _a.manager, lineItemAdjustmentRepository = _a.lineItemAdjustmentRepository, discountService = _a.discountService;
        var _this = 
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        lineItemAdjustmentRepo = manager.getCustomRepository(this.lineItemAdjustmentRepo_);
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (metadata) {
                                            lineItemAdjustment.metadata = (0, utils_1.setMetadata)(lineItemAdjustment, metadata);
                                        }
                                        try {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/];
                                case 2:
                                    query = (0, utils_1.buildQuery)(selectorOrIds);
                                    return [4 /*yield*/, lineItemAdjustmentRepo.find(query)];
                                case 3:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.discountService.calculateDiscountForLineItem(discount.id, lineItem, cart)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(cart.items.map(function (li) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
