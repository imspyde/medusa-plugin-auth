...
export declare abstract class AbstractPaymentService extends TransactionBaseService implements PaymentService {
    ...
    abstract createPaymentNew(paymentInput: PaymentProviderDataInput): Promise<PaymentSessionData>;
    ...
    abstract updatePaymentNew(paymentSessionData: PaymentSessionData, paymentInput: PaymentProviderDataInput): Promise<PaymentSessionData>;
