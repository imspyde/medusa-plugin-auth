    ...
    SwapService.prototype.createCart = function (swapId, customShippingOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var swapRepo, swap, order, discounts, cart, customShippingOptionServiceTx, customShippingOptions_1, customShippingOptions_1_1, customShippingOption, e_2_1, lineItemServiceTx, lineItemAdjustmentServiceTx;
                            var e_2, _a;
                            var _this = this;
                            var _b;
                            return __generator(this, function (_c) {
    ...
    SwapService.prototype.registerCartCompletion = function (swapId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var swap, cart, payment, items, inventoryServiceTx, paymentProviderServiceTx, cartServiceTx, items_1, items_1_1, item, err_3, e_3_1, total, paymentStatus, inventoryServiceTx, items_2, items_2_1, item, e_4_1, swapRepo, result, shippingOptionServiceTx, _a, _b, method, e_5_1;
    ...
    SwapService.prototype.createFulfillment = function (swapId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var metadata, no_notification, swapRepo, swap, order, evaluatedNoNotification, _a, successfullyFulfilled, _b, _c, f, lineItemServiceTx, _loop_1, _d, _e, item, e_7_1, result;
                            var e_8, _f, e_7, _g;
                            var _h;
    ...
    SwapService.prototype.createShipment = function (swapId, fulfillmentId, trackingLinks, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var metadata, no_notification, swapRepo, swap, evaluatedNoNotification, shipment, lineItemServiceTx, _loop_2, _a, _b, i, e_9_1, result;
                            var e_9, _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
