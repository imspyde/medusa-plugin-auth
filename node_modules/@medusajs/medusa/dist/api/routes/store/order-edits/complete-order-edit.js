...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, orderEditService, orderService, paymentProviderService, manager, userId, orderEdit;
    var _a, _b, _c, _d, _e;
        ...
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                        var orderEditServiceTx, orderServiceTx, paymentProviderServiceTx, orderEdit, returned, _a, _b, payment, e_1_1;
                        var e_1, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 2:
                                    returned = _d.sent();
                                    if (!orderEdit.payment_collection) return [3 /*break*/, 10];
                                    _d.label = 3;
                                case 3:
                                ...
                                case 9:
                                    ...
                                    return [7 /*endfinally*/];
                                case 10: return [2 /*return*/, returned];
                            }
                        });
                    }); })];
            case 1:
