...
exports.default = {
    load: (container, configModule, options) => {
        ...
        if ((_a = options.linkedin) === null || _a === void 0 ? void 0 : _a.admin) {
            new linkedin_1.LinkedinAdminStrategy(container, configModule, options.linkedin);
        }
        if ((_b = options.linkedin) === null || _b === void 0 ? void 0 : _b.store) {
            new linkedin_1.LinkedinStoreStrategy(container, configModule, options.linkedin);
        }
    },
