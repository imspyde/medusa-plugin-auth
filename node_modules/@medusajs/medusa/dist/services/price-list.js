...
var PriceListService = /** @class */ (function (_super) {
    ...
    PriceListService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, priceListRepo, q, priceListSelector, query, groups, _a, priceLists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        query = (0, utils_1.buildQuery)(priceListSelector, config);
                        groups = query.where.customer_groups;
                        query.where.customer_groups = undefined;
                        return [4 /*yield*/, priceListRepo.listAndCount(query, groups)];
                    case 1:
    ...
    PriceListService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, priceListRepo, q, priceListSelector, _a, relations, query, groups;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        manager = this.manager_;
                        priceListRepo = manager.getCustomRepository(this.priceListRepo_);
                        q = selector.q, priceListSelector = __rest(selector, ["q"]);
                        _a = (0, utils_1.buildQuery)(priceListSelector, config), relations = _a.relations, query = __rest(_a, ["relations"]);
                        groups = query.where.customer_groups;
                        delete query.where.customer_groups;
                        if (!q) return [3 /*break*/, 2];
                        return [4 /*yield*/, priceListRepo.getFreeTextSearchResultsAndCount(q, query, groups, relations)];
                    case 1: return [2 /*return*/, _b.sent()];
                    case 2: return [4 /*yield*/, priceListRepo.listAndCount(__assign(__assign({}, query), { relations: relations }), groups)];
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        productVariantRepo = manager.getCustomRepository(this.productVariantRepo_);
                                                ...
                                                return __generator(this, function (_c) {
                                                    switch (_c.label) {
                                                        case 0:
                                                            ...
                                                            _a = p;
                                                            return [4 /*yield*/, Promise.all(p.variants.map(function (v) { return __awaiter(_this, void 0, void 0, function () {
                                                                    var _a, prices;
                                                                    return __generator(this, function (_b) {
                                                                        switch (_b.label) {
                                                                            ...
                                                                            case 1:
                                                                                ...
                                                                                return [2 /*return*/, productVariantRepo.create(__assign(__assign({}, v), { prices: prices }))];
                                                                        }
                                                                    });
                                                                }); }))];
                                                        case 1:
    ...
    PriceListService.prototype.addCurrencyFromRegion = function (prices) {
        return __awaiter(this, void 0, void 0, function () {
            var prices_, regionServiceTx, prices_1, prices_1_1, price, p, region, e_3_1;
            var e_3, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        prices_ = [];
                        regionServiceTx = this.regionService_.withTransaction(this.manager_);
                        _b.label = 1;
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        if (!!prices_1_1.done) return [3 /*break*/, 6];
                        price = prices_1_1.value;
                        p = __assign({}, price);
                        if (!p.region_id) return [3 /*break*/, 4];
                        return [4 /*yield*/, regionServiceTx.retrieve(p.region_id)];
                    case 3:
                        region = _b.sent();
                    ...
                    case 8:
                        ...
                        return [7 /*endfinally*/];
                    case 9: return [2 /*return*/, prices_];
                }
            });
        });
    };
