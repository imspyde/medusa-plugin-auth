...
declare class ProductImportStrategy extends AbstractBatchJobStrategy {
    ...
    constructor({ batchJobService, productService, salesChannelService, productVariantService, shippingProfileService, regionService, fileService, manager, featureFlagRouter, }: ProductImportInjectedProps);
