...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payment_id, paymentCollectionService, payment_collection;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                payment_id = req.params.payment_id;
                paymentCollectionService = req.scope.resolve("paymentCollectionService");
                return [4 /*yield*/, paymentCollectionService.authorize(payment_id)];
            case 1:
...
//# sourceMappingURL=authorize-payment-collection.js.map