...
var IdempotencyKeyService = /** @class */ (function (_super) {
    ...
    function IdempotencyKeyService(_a) {
        var manager = _a.manager, idempotencyKeyRepository = _a.idempotencyKeyRepository;
        var _this = 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.retrieve(headerKey).catch(function () { return void 0; })];
                                    case 1:
                                        key = _a.sent();
                                        if (key) {
                                            return [2 /*return*/, key];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        iKey = _a.sent();
                        if (!iKey) {
                            throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_FOUND, "Idempotency key ".concat(idempotencyKey, " was not found"));
                        }
