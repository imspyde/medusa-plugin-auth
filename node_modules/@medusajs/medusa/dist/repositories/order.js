...
var OrderRepository = /** @class */ (function (_super) {
    ...
    OrderRepository.prototype.findWithRelations = function (relations, optionsWithoutRelations) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (0, lodash_1.map)(entities, function (e) { return lodash_1.merge.apply(void 0, __spreadArray([{}], __read(entitiesAndRelationsById[e.id]), false)); })];
                }
            });
        });
    };
    OrderRepository.prototype.findOneWithRelations = function (relations, optionsWithoutRelations) {
        if (relations === void 0) { relations = []; }
        if (optionsWithoutRelations === void 0) { optionsWithoutRelations = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
    ...
    OrderRepository = __decorate([
        (0, typeorm_1.EntityRepository)(models_1.Order)
    ], OrderRepository);
