...
export default class PaymentProviderService extends TransactionBaseService {
    ...
    createSessionNew(sessionInput: PaymentProviderDataInput): Promise<PaymentSession>;
    /**
    ...
    refreshSessionNew(paymentSession: PaymentSession, sessionInput: PaymentProviderDataInput): Promise<PaymentSession>;
    /**
    ...
    updateSessionNew(paymentSession: PaymentSession, sessionInput: PaymentProviderDataInput): Promise<PaymentSession>;
    ...
    createPaymentNew(paymentInput: Omit<PaymentProviderDataInput, "customer"> & {
        payment_session: PaymentSession;
    }): Promise<Payment>;
