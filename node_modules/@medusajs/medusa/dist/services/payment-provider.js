...
var PaymentProviderService = /** @class */ (function (_super) {
    ...
    PaymentProviderService.prototype.createSessionNew = function (sessionInput) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        provider = this.retrieveProvider(sessionInput.provider_id);
                                        return [4 /*yield*/, provider
                                                .withTransaction(transactionManager)
    ...
    PaymentProviderService.prototype.refreshSessionNew = function (paymentSession, sessionInput) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    _a.sent();
                                    return [4 /*yield*/, this.createSessionNew(sessionInput)];
    ...
    PaymentProviderService.prototype.updateSessionNew = function (paymentSession, sessionInput) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PaymentProviderService.prototype.createPayment = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var paymentSession, currency_code, amount, provider, paymentData, paymentRepo, created;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        paymentSession = data.payment_session, currency_code = data.currency_code, amount = data.amount;
                                        provider = this.retrieveProvider(paymentSession.provider_id);
                                        return [4 /*yield*/, provider
                                                .withTransaction(transactionManager)
    ...
    PaymentProviderService.prototype.createPaymentNew = function (paymentInput) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var payment_session, currency_code, amount, provider_id, provider, paymentData, paymentService;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        payment_session = paymentInput.payment_session, currency_code = paymentInput.currency_code, amount = paymentInput.amount, provider_id = paymentInput.provider_id;
                                        provider = this.retrieveProvider(provider_id);
                                        return [4 /*yield*/, provider
                                                .withTransaction(transactionManager)
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, paymentService.withTransaction(transactionManager).create({
                                ...
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (this.featureFlagRouter_.isFeatureEnabled(order_editing_1.default.key) &&
                                            status === models_1.PaymentSessionStatus.AUTHORIZED) {
