...
var NewTotalsService = /** @class */ (function (_super) {
    ...
    function NewTotalsService(_a) {
        var manager = _a.manager, taxProviderService = _a.taxProviderService, featureFlagRouter = _a.featureFlagRouter, taxCalculationStrategy = _a.taxCalculationStrategy;
    ...
    NewTotalsService.prototype.getLineItemTotals = function (items, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, lineItemsTaxLinesMap, itemContainsTaxLines, lineItemsTaxLines, calculationMethod, itemsTotals, items_1, items_1_1, item, lineItemAllocation, _c, _d, e_1_1;
            var e_1, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        items = Array.isArray(items) ? items : [items];
                        manager = (_b = this.transactionManager_) !== null && _b !== void 0 ? _b : this.manager_;
                        ...
                        return [3 /*break*/, 3];
                    case 1:
                        if (items.some(function (item) { return !item.variant; })) {
                            throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.INVALID_DATA, "Unable to fetch tax lines to compute line item totals as one of the item variant is missing but required for the tax lines to be computed. Might be due to a missing relation items.variant");
                        }
                        return [4 /*yield*/, this.taxProviderService_
                                .withTransaction(manager)
                                .getTaxLinesMap(items, calculationContext)];
                    case 2:
                        lineItemsTaxLines = (_f.sent()).lineItemsTaxLines;
    ...
    NewTotalsService.prototype.getLineItemTotals_ = function (item, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var subtotal, discount_total, totals, _d, noDiscountContext, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        discount_total = (((_b = lineItemAllocation.discount) === null || _b === void 0 ? void 0 : _b.unit_amount) || 0) * item.quantity;
                        totals = {
                            ...
                            tax_total: 0,
                            tax_lines: (_c = item.tax_lines) !== null && _c !== void 0 ? _c : [],
                        };
                        if (includeTax) {
                        ...
                        if (item.is_return) {
                            if (!(0, utils_1.isDefined)(item.tax_lines)) {
                        ...
                        if (!(totals.tax_lines.length > 0)) return [3 /*break*/, 3];
                        _d = totals;
    ...
    NewTotalsService.prototype.getLineItemTotalsLegacy = function (item, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var subtotal, discount_total, totals, includesTax, taxIncludedInPrice;
    ...
    NewTotalsService.prototype.getLineItemRefund = function (lineItem, _a) {
        ...
        var discountAmount = (((_c = (_b = calculationContext.allocation_map[lineItem.id]) === null || _b === void 0 ? void 0 : _b.discount) === null || _c === void 0 ? void 0 : _c.unit_amount) ||
            0) * lineItem.quantity;
        if (!(0, utils_1.isDefined)(lineItem.tax_lines)) {
    ...
    NewTotalsService.prototype.getGiftCardTotals = function (giftCardableAmount, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                giftAmount = giftCards.reduce(function (acc, next) { return acc + next.balance; }, 0);
                result.total = Math.min(giftCardableAmount, giftAmount);
                if (region === null || region === void 0 ? void 0 : region.gift_cards_taxable) {
    ...
    NewTotalsService.prototype.getGiftCardTransactionsTotals = function (_a) {
        ...
        return giftCardTransactions.reduce(function (acc, next) {
            ...
            if (next.is_taxable === null && (region === null || region === void 0 ? void 0 : region.gift_cards_taxable)) {
    ...
    NewTotalsService.prototype.getShippingMethodTotals = function (shippingMethods, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, shippingMethodsTaxLinesMap, shippingMethodContainsTaxLines, calculationContextWithGivenMethod, shippingMethodsTaxLines, calculationMethod, shippingMethodsTotals, shippingMethods_1, shippingMethods_1_1, shippingMethod, _c, _d, e_2_1;
            var e_2, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                    ...
                    case 2:
                        shippingMethodsTaxLines = (_f.sent()).shippingMethodsTaxLines;
                    ...
                    case 5:
                        ...
                        _c = shippingMethodsTotals;
                        _d = shippingMethod.id;
                    ...
                    case 10:
                        try {
                            if (shippingMethods_1_1 && !shippingMethods_1_1.done && (_e = shippingMethods_1.return)) _e.call(shippingMethods_1);
                        }
