...
var OrderService = /** @class */ (function (_super) {
    ...
    OrderService.prototype.retrieveWithTotals = function (orderId, options, totalsConfig) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        order = _a.sent();
                        return [4 /*yield*/, this.decorateTotals(order, totalsConfig)];
    ...
    OrderService.prototype.createFromCart = function (cartOrId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var cartServiceTx, inventoryServiceTx, exists, cart, _a, payment, region, total, paymentStatus, orderRepo, shippingMethods, toCreate, draft, rawOrder, order, gcBalance, gcService, _b, _c, g, newBalance, usage, e_1_1, shippingOptionServiceTx, lineItemServiceTx;
                            var e_1, _d;
                            var _this = this;
                            var _e;
                                ...
                                switch (_f.label) {
                                    ...
                                    case 4:
                                        ...
                                        return [4 /*yield*/, Promise.all(cart.items.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, inventoryServiceTx.confirmInventory(item.variant_id, item.quantity)];
                                                        case 1: return [2 /*return*/, _a.sent()];
                                                    }
                                                });
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.sent();
                                                            _a.label = 2;
                                                        case 2: return [4 /*yield*/, cartServiceTx.update(cart.id, { payment_authorized_at: null })];
                                                        case 3:
                                                            _a.sent();
                                                            throw err;
                                                    }
                                    ...
                                    case 7:
                                        ...
                                        if (!(cart.type === "draft_order")) return [3 /*break*/, 9];
                                    ...
                                    case 10:
                                        order = _f.sent();
                                        if (!(total !== 0 && payment)) return [3 /*break*/, 12];
                                        return [4 /*yield*/, this.paymentProviderService_
                                                .withTransaction(manager)
                                    ...
                                    case 12:
                                        ...
                                        gcBalance = (((_e = cart.region) === null || _e === void 0 ? void 0 : _e.gift_cards_taxable)
                                        ...
                                        return [4 /*yield*/, Promise.all([
                                                cart.items.map(function (item) {
                                                    return [
                                                        ...
                                                        inventoryServiceTx.adjustInventory(item.variant_id, -item.quantity),
                                                    ];
                                                }),
                                                cart.shipping_methods.map(function (method) {
    ...
    OrderService.prototype.cancel = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var order, throwErrorIf, notCanceled, inventoryServiceTx, _a, _b, item, e_6_1, paymentProviderServiceTx, _c, _d, p, e_7_1, orderRepo, result;
                            var e_6, _e, e_7, _f;
                            var _g;
                            return __generator(this, function (_h) {
                                switch (_h.label) {
    ...
    OrderService.prototype.capturePayment = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var orderRepo, order, paymentProviderServiceTx, payments, _loop_2, _a, _b, p, e_8_1, result;
                            var e_8, _c;
                            var _this = this;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        metadata = config.metadata, no_notification = config.no_notification;
                        return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                                var order, fulfillments, successfullyFulfilled, fulfillments_1, fulfillments_1_1, f, _loop_3, this_1, _a, _b, item, e_9_1, orderRepo, result, evaluatedNoNotification, eventBusTx, fulfillments_2, fulfillments_2_1, fulfillment, e_10_1;
                                var e_11, _c, e_9, _d, e_10, _e;
                                var _f;
    ...
    OrderService.prototype.decorateTotalsLegacy = function (order, totalsFields) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totalsFields_1, totalsFields_1_1, totalField, _a, _b, giftCardBreakdown, _c, _d, _e, _f, paid_total, refunded_total, items, _g, _h, item, _j, _k, _l, e_12_1, _m, _o, s, items, _p, _q, item, _r, _s, _t, e_13_1, e_14_1, _u, _v, c, items, _w, _x, item, _y, _z, _0, e_15_1, e_16_1, e_17_1;
            var e_17, _1, e_12, _2, _3, e_14, _4, e_13, _5, _6, e_16, _7, e_15, _8, _9;
            return __generator(this, function (_10) {
                switch (_10.label) {
                    ...
                    case 18:
                        ...
                        _g = (e_12 = void 0, __values(order.items)), _h = _g.next();
                        _10.label = 19;
                    case 19:
                    ...
                    case 26:
                        ...
                        _m = (e_14 = void 0, __values(order.swaps)), _o = _m.next();
                        _10.label = 27;
                    case 27:
                    ...
                    case 28:
                        ...
                        _p = (e_13 = void 0, __values(s.additional_items)), _q = _p.next();
                        _10.label = 29;
                    case 29:
                    ...
                    case 41:
                        ...
                        _u = (e_16 = void 0, __values(order.claims)), _v = _u.next();
                        _10.label = 42;
                    case 42:
                    ...
                    case 43:
                        ...
                        _w = (e_15 = void 0, __values(c.additional_items)), _x = _w.next();
                        _10.label = 44;
                    case 44:
     ...
     * @protected
     */
    OrderService.prototype.decorateTotals = function (order, totalsFieldsOrConfig) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return __awaiter(this, void 0, void 0, function () {
            var manager, newTotalsServiceTx, calculationContext, orderItems, orderShippingMethods, itemsTotals, shippingTotals, item_tax_total, shipping_tax_total, giftCardTotal, _j, _k, swap, _l, _m, claim;
            var e_18, _o, e_19, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        if (!Array.isArray(totalsFieldsOrConfig)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.decorateTotalsLegacy(order, totalsFieldsOrConfig)];
                    case 1: return [2 /*return*/, _q.sent()];
                    case 2:
                    ...
                    case 3:
                        calculationContext = _q.sent();
                        orderItems = __spreadArray([], __read(((_b = order.items) !== null && _b !== void 0 ? _b : [])), false);
                        orderShippingMethods = __spreadArray([], __read(((_c = order.shipping_methods) !== null && _c !== void 0 ? _c : [])), false);
                        return [4 /*yield*/, newTotalsServiceTx.getLineItemTotals(orderItems, {
                    ...
                    case 5:
                        shippingTotals = _q.sent();
                        order.subtotal = 0;
                        order.discount_total = 0;
                        order.shipping_total = 0;
                        order.refunded_total =
                            Math.round((_d = order.refunds) === null || _d === void 0 ? void 0 : _d.reduce(function (acc, next) { return acc + next.amount; }, 0)) ||
                                0;
                        order.paid_total =
                            ((_e = order.payments) === null || _e === void 0 ? void 0 : _e.reduce(function (acc, next) { return (acc += next.amount); }, 0)) || 0;
                        order.refundable_amount = order.paid_total - order.refunded_total || 0;
                        item_tax_total = 0;
                        shipping_tax_total = 0;
                        order.items = (order.items || []).map(function (item) {
                            var _a, _b, _c, _d;
                            var refundable = newTotalsServiceTx.getLineItemRefund(__assign(__assign({}, item), { quantity: item.quantity - (item.returned_quantity || 0) }), {
                                calculationContext: calculationContext,
                                taxRate: order.tax_rate,
                            });
                            var itemWithTotals = __assign(__assign(__assign({}, item), ((_a = itemsTotals[item.id]) !== null && _a !== void 0 ? _a : {})), { refundable: refundable });
                            order.subtotal += (_b = itemWithTotals.subtotal) !== null && _b !== void 0 ? _b : 0;
                            order.discount_total += (_c = itemWithTotals.discount_total) !== null && _c !== void 0 ? _c : 0;
                            item_tax_total += (_d = itemWithTotals.tax_total) !== null && _d !== void 0 ? _d : 0;
                        ...
                        return [4 /*yield*/, this.newTotalsService_.getGiftCardTotals(order.subtotal - order.discount_total, {
                                ...
                                giftCardTransactions: (_f = order.gift_card_transactions) !== null && _f !== void 0 ? _f : [],
                            })];
                    case 6:
                        giftCardTotal = _q.sent();
                        ...
                        try {
                            for (_j = __values((_g = order.swaps) !== null && _g !== void 0 ? _g : []), _k = _j.next(); !_k.done; _k = _j.next()) {
                                swap = _k.value;
                                swap.additional_items = swap.additional_items.map(function (item) {
                                    item.refundable = newTotalsServiceTx.getLineItemRefund(__assign(__assign({}, item), { quantity: item.quantity - (item.returned_quantity || 0) }), {
                                        calculationContext: calculationContext,
                                        taxRate: order.tax_rate,
                                    });
                                    return item;
                        ...
                        try {
                            for (_l = __values((_h = order.claims) !== null && _h !== void 0 ? _h : []), _m = _l.next(); !_m.done; _m = _l.next()) {
                                claim = _m.value;
